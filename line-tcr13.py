...
cl = LINETCR.LINE()
cl.login(token="EmjMTer71pEYnPsxKXL0.Dy7Jc58T5nzC6DGUouXISa.MucUEmWlE6wA9SoJj0m6buAlSHRDccO1rj6exsTKtF0=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmvmC65AhRFwyaYkHEdd.AaRklDERafMmmw4gJp8JRq.bf7mjrU/GAPiHJvLuYpbb/UQKWQXtrYR9JCI96EAne4=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Em8Uj1MRqCDmBO5XiYu5.T2Obu6kd2POuq9/WqXGtnq.Eaqof4oV8GKOTFkpRESnEuh0odD3CEpkOVmeKezp3N0=")
kk.loginResult()

ar = LINETCR.LINE()
ar.login(token="EmnPPuIYEvCefe1LcZe5.l+V2gjkPHX/vw2MT3B1zrq.JiMT9we/Iu7spVbB7hJPiJR2vOjfU9vEHc1Jj54qjxo=")
ar.loginResult()

pi = LINETCR.LINE()
pi.login(token="EmLV5twOWfR6ybWCUO0b.sDTrH/zMSMOdJJyRwe3qQW.eJvaeOQigQYb4ukESxrJdzaTHRe1I9LExmgCz5WfzJ4=")
pi.loginResult()
...
admin=["ub76a0153a283da9a1443dfb043181335","u49db5187e666b26a038e362b584dd0ab","ube597dd17603406a6b278bc62cc5fdcf","u680aca2dd7ab00598c316e068cff23ad","u758ee30b9f2de4d65ce9d82e394c62b0"]
wait = {
    'contact':True,
    'autoJoin':True,
...
#--------------------------------------------
        ...
        #-------------Fungsi Creator Start-----------------#
                ...
                if msg.toType == 2:
                      msg.contentType = 13
                      Creatorbot = "ub76a0153a283da9a1443dfb043181335"
                      try:
